...
public class ModelPiranha<T extends EntityPiranha> extends HierarchicalModel<T> {
	...
	public ModelPiranha(ModelPart root) {
		...
		toothBL = root.getChild("root").getChild("toothBL");
		toothBML = root.getChild("root").getChild("toothBML");
		toothMBR = root.getChild("root").getChild("toothMBR");
		toothBR = root.getChild("root").getChild("toothBR");
		head = root.getChild("root").getChild("head");
		toothTL = root.getChild("root").getChild("toothTL");
		toothTM = root.getChild("root").getChild("toothTM");
		toothTR = root.getChild("root").getChild("toothTR");
		bodyMain = root.getChild("root").getChild("bodyMain");
		finDorsal = root.getChild("root").getChild("finDorsal");
		finR = root.getChild("root").getChild("finR");
		finL = root.getChild("root").getChild("finL");
